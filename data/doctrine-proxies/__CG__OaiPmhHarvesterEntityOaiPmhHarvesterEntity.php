 ...
 */
class OaiPmhHarvesterEntity extends \OaiPmhHarvester\Entity\OaiPmhHarvesterEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OaiPmhHarvesterEntity $proxy) {
